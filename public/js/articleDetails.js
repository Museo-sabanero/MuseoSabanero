  ...
  methods: {
    downloadQRCode: function downloadQRCode() {
      ...
      fetch(this.qrCodeSrc).then(function (res) {
        ...
        return (0,file_saver__WEBPACK_IMPORTED_MODULE_6__.saveAs)(blob, "".concat(_this2.article.name, " - ").concat(_this2.article.numRefInter, ".png"));
      });
    },
    goBack: function goBack() {
      this.$router.push({
