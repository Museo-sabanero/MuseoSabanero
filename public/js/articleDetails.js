...
/* harmony import */ var _services_RestaurationService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/RestaurationService */ "./resources/js/services/RestaurationService.js");
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            _context.next = 14;
            return _services_RestaurationService__WEBPACK_IMPORTED_MODULE_4__["default"].getRestaurationsByArticle(_this.id).then(function (data) {
              console.log('rest');
              console.log(data);
  ...
  methods: {
    downloadQRCode: function downloadQRCode() {
      fetch(this.qrCodeSrc).then(function (res) {
        ...
        return (0,file_saver__WEBPACK_IMPORTED_MODULE_5__.saveAs)(blob, 'my-qr-code.png');
      });
    },
    goBack: function goBack() {
      this.$router.push({
