    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _services_BitacoraService__WEBPACK_IMPORTED_MODULE_0__["default"].getDetails(_this.id).then(function (data) {
              _this.list = data;
              var datos = _this.list[0];
              _this.bitacora.id = datos.id, _this.bitacora.elemento = datos.elemento, _this.bitacora.usuario = datos.usuario, _this.bitacora.status = datos.status, _this.bitacora.nota = datos.nota, _this.bitacora.fecha = datos.fecha, _this.bitacora.id_articulo = datos.id_articulo;
            });
          case 2:
            _context.next = 4;
            return _services_BitacoraService__WEBPACK_IMPORTED_MODULE_0__["default"].getBitacoraByIdArticulo(_this.bitacora.id_articulo).then(function (data) {
              _this.ListBitacora = data;
            });
          case 4:
          case "end":
