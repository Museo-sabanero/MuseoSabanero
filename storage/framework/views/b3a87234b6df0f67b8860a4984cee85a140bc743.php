...
<main class="main-wrap login-page mt-2">
    ...
    <img src="<?php echo e(asset('public/images/museo/frontPage.png')); ?>" class="d-block mx-auto rounded-circle my-3" style="width: 250px; height: 250px; object-fit: cover;" alt="Portada">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\xampp\htdocs\resources\views/auth/login.blade.php ENDPATH**/ ?>